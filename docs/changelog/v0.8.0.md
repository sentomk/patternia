...
Compared with v0.7.6, this version removes the legacy compact terminal form
and focuses the public usage on `match(x) | on{...}`. It also upgrades
variant dispatch internals with a
