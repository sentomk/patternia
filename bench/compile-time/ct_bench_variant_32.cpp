...
namespace {
  ...
  using VAlt32 = std::variant<Token<0>,  Token<1>,  Token<2>,  Token<3>,
  ...
  int ct_var_alt_route(const VAlt32 &v) {
    using namespace ptn;
    return match(v)
           | on(alt<0>() >> 1,  alt<1>() >> 2,  alt<2>() >> 3,
                alt<3>() >> 4,  alt<4>() >> 5,  alt<5>() >> 6,
                alt<6>() >> 7,  alt<7>() >> 8,  alt<8>() >> 9,
                alt<9>() >> 10, alt<10>() >> 11, alt<11>() >> 12,
                alt<12>() >> 13, alt<13>() >> 14, alt<14>() >> 15,
                alt<15>() >> 16, alt<16>() >> 17, alt<17>() >> 18,
                alt<18>() >> 19, alt<19>() >> 20, alt<20>() >> 21,
                alt<21>() >> 22, alt<22>() >> 23, alt<23>() >> 24,
                alt<24>() >> 25, alt<25>() >> 26, alt<26>() >> 27,
                alt<27>() >> 28, alt<28>() >> 29, alt<29>() >> 30,
                alt<30>() >> 31, alt<31>() >> 32,
                __ >> 0);
  }
