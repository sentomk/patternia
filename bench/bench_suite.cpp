...
#define PTN_SL_LIT_BLOCK_16(base)                                   \
  PTN_SL_LIT_CASE_128((base) + 0), PTN_SL_LIT_CASE_128((base) + 1), \
      PTN_SL_LIT_CASE_128((base) + 2),                              \
      PTN_SL_LIT_CASE_128((base) + 3),                              \
      PTN_SL_LIT_CASE_128((base) + 4),                              \
      PTN_SL_LIT_CASE_128((base) + 5),                              \
      PTN_SL_LIT_CASE_128((base) + 6),                              \
      PTN_SL_LIT_CASE_128((base) + 7),                              \
      PTN_SL_LIT_CASE_128((base) + 8),                              \
      PTN_SL_LIT_CASE_128((base) + 9),                              \
      PTN_SL_LIT_CASE_128((base) + 10),                             \
      PTN_SL_LIT_CASE_128((base) + 11),                             \
      PTN_SL_LIT_CASE_128((base) + 12),                             \
      PTN_SL_LIT_CASE_128((base) + 13),                             \
      PTN_SL_LIT_CASE_128((base) + 14),                             \
      PTN_SL_LIT_CASE_128((base) + 15)

  static int
  patternia_pipe_literal_match_128_on_stateless_route(int x) {
    using namespace ptn;

    return match(x)
           | on(
               PTN_SL_LIT_BLOCK_16(1),
  ...
  static void BM_PatterniaPipe_LiteralMatch128On_Stateless(
      benchmark::State &state) {
    run_workload(
        state,
        literal_128_workload(),
...
PTN_REGISTER_STABLE_BENCH(
    BM_PatterniaPipe_LiteralMatch128On_Stateless);
